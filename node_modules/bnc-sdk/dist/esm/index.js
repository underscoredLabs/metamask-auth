...
function configuration(config) {
  ...
  const previousConfiguration = this._configurations.get(config.scope.toLowerCase());
  ...
  this._configurations.set(config.scope.toLowerCase(), { ...config,
    ...emitter,
    subscription
  });
...
function handleMessage(msg) {
  ...
  if (event && event.transaction) {
    ...
    if (watchedAddress) {
      ...
      const configurationEmitterResult = configuration && configuration.emitter && configuration.emitter.emit(newState);
