        ...
        switch (_context14.prev = _context14.next) {
          case 0:
            ...
            return new Promise(function (resolve) {
              resolve(require('./providerEngine-2e1eae0d.js'));
            });
          ...
          case 26:
            ...
            _context14.next = 30;
            return new Promise(function (resolve) {
              resolve(require('./hd-wallet-b0d3577d.js'));
            });

          case 30:
            _yield$Promise2 = _context14.sent;
            generateAddresses = _yield$Promise2.generateAddresses;
            isValidPath = _yield$Promise2.isValidPath;
            _context14.next = 35;
            return new Promise(function (resolve) {
              resolve(_interopNamespace(require('@ledgerhq/hw-transport-u2f')));
            });

          case 35:
            _yield$Promise3 = _context14.sent;
            TransportU2F = _yield$Promise3["default"];
            _context14.next = 39;
            return new Promise(function (resolve) {
              resolve(_interopNamespace(require('@ledgerhq/hw-app-eth')));
            });

          case 39:
            _yield$Promise4 = _context14.sent;
            Eth = _yield$Promise4["default"];
            _context14.next = 43;
            return new Promise(function (resolve) {
          ...
          case 43:
            ...
            _context14.next = 46;
            return new Promise(function (resolve) {
              resolve(_interopNamespace(require('ethereumjs-util')));
            });
          ...
          case 46:
            ...
            _context14.next = 49;
            return new Promise(function (resolve) {
              resolve(_interopNamespace(require('buffer')));
            });
